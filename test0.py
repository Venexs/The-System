...
initial_height = 10
target_height = 449
window_width = 696  # User-defined width

window.geometry(f"{window_width}x{initial_height}")  # Initial size (smaller height)

# Animate window opening
animate_window(window, target_height, window_width, step=3, delay=1)
