...
def update_fun():
    ...
    fin_path= os.path.dirname(parent_dir)

    file_path = os.path.join(parent_dir, 'main.zip')
    urllib.request.urlretrieve('https://github.com/Venexs/System_SL/archive/refs/heads/main.zip', file_path)

    zip_loc=parent_dir+'\\'+'Test Update.zip'
    with ZipFile(zip_loc, 'r') as zObject: 
        zObject.extractall(path=fin_path)
