...
def third():
    ...
    with open('Files\Skills\Skill.json', 'r') as skill_file:
        ...
        skill_file_data["Complete Control"]=[{
            "lvl":"MAX",
            "type":"Job",
            "desc":"You who have gained this skill, now have access to all that the System provides.... For better or worse",
            "pl_point":0,
    ...
    with open("Files/status.json", 'r') as fson:
        data=json.load(fson)
    data["status"][1]['job']="The Arhitect"
