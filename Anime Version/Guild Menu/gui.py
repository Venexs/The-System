...
canvas.tag_bind(image_4, "<ButtonPress-1>", lambda event: GuildOption(event, "Create"))
...
canvas.tag_bind(image_5, "<ButtonPress-1>", lambda event: GuildOption(event, "Join"))
