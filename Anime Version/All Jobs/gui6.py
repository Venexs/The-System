...
top_images = [f"thesystem/alt_top_bar/{str(i).zfill(4)}.png" for i in range(2, 501, 2)]
bottom_images = [f"thesystem/alt_bottom_bar/{str(i).zfill(4)}.png" for i in range(2, 501, 2)]
