...
top_preloaded_images = thesystem.system.preload_images(top_images, (400, 19))
bottom_preloaded_images = thesystem.system.preload_images(bottom_images, (400, 16))
...
player = thesystem.system.VideoPlayer(canvas, video_path, 478.0, 330.0, resize_factor=0.8, pause_duration=0.5)
