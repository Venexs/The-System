...
# Load presets and handle missing message
with open("Files\Mod\presets.json", 'r') as pres_file:
    pres_file_data = ujson.load(pres_file)
    messages_dict = pres_file_data.get("Message", {})
    file_path = messages_dict.get(message, ["Files/Mod/default/messages/default_message.png"])[0]  # Fallback to default
...
image_3 = canvas.create_image(canvas_center_x, canvas_center_y, image=image_image_3)
