...
top_preloaded_images = thesystem.system.preload_images(top_images, (332, 30))
bottom_preloaded_images = thesystem.system.preload_images(bottom_images, (322, 25))
...
player = thesystem.system.VideoPlayer(canvas, video_path, 478.0, 277.0, pause_duration=0.7)
